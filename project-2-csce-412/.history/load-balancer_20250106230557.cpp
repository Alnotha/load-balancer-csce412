...
/* The line `printf("Servers Running:", servers.size());` is attempting to print the string "Servers
Running:" to the console, but it is missing the placeholder for the actual value of
`servers.size()`. */
        printf("Servers Running:", servers.size());
